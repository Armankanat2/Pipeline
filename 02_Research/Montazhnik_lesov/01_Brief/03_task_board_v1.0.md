...
- Kod kursa: `ML`
- Tekushchiy stage: `post-formal QA / revise`
- Owner: vy
- Prioritet: vysokiy
- Deadline: `2026-05-30`
...
- [x] Sozdat papku kursa
- [x] Zafiksirovat brief
...
- poka net pasporta konkretnoi sistemy lesov;
- poka net tekhnicheskoy validatsii eksperta;
- poka net foto i skhem, kotorye mozhno bezopasno ispolzovat v kurse.

## Control contour

- Course profile: `_Control/Course_Profile.md`
- Variant profiles: `_Control/Variant_Profile_*.md`
- Decision log: `_Control/Decision_Log.md`
...
- Pilot signals: `_Feedback/Pilot_Report.md`
- Retrospective: `_Feedback/Retrospective.md`
- Client signals: `_Feedback/Client_Feedback.md`
- Improvement items: `_Feedback/Improvement_Items.md`

# Learning Outcomes Template v1

## Naznachenie

Shablon nuzhen dlya fiksatsii izmerimykh rezultatov obucheniya, svyazannykh s realnym povedeniem slushatelya.
...
|---|---|---|---|---|---|
| LO-01 |  | Slushatel mozhet... |  | test / situatsiya / nablyudenie / foto | core / supporting |
...
- Outcomes gotovy dlya `course architecture`: `yes / no`
